    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="hover:bg-primary group ml-[-8px] flex w-min items-center gap-2 rounded-sm p-2">
            {formatApy(netApy)}
            {rewards.length > 0 && (
                ...
                <div className="flex items-end gap-1 font-light">
                  ...
                  {reward.depositUrl && getDomain(reward.depositUrl) !== window.location.hostname && (
                    <a
                      ...
                      className="bg-morpho-brand/50 flex items-center gap-1 rounded-sm px-1"
